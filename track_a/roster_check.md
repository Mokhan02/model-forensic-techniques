...
**Status: 1/5 live-verified (Claude Sonnet 5, 2026-09-09). Remaining 4
(GPT-5.6 Sol, Gemini 3.1 Pro, Qwen 3.8, DeepSeek-V4) are still
...
earlier in this project. (It also just caught a real infra bug and two API
shape changes on the one row that has been checked — see that row's notes.)
